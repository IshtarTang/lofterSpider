...
如果有什么想要的功能可以说，我觉得有必要或者心情好会在有空的时候写。但是不要建议我写什么功能，除非你的建议跟着pull request或者给我打钱。

#### 不要跟我讲这些

合集问题在issue里回答过，我这里再写一次，目前合集功能只在手机端有，手机端跟web端的接口是分开的，如果现在写爬合集需要从头弄很多东西，而且没有技术基础的人很难弄到手机端cookies，我自己没这个需求+就算写出来有这个需求的人也用不了，所以在合集功能上web端之前不可能出爬合集功能。在web端更新出合集之前再来问爬合集的会被我拉黑。

不要特地来跟我说觉得程序结构可以优化！我当然知道可以优化啊我现在看一个函数传十几个参我也觉得眼前一黑，开始写这玩意时我刚开始学爬虫，现在修结构唯一作用就是显得我很闲。
