...
不会提issue可以直接邮箱找我：18975585675@163.com，或者微博@唐文_Ishtar，不过微博这个号最近没在用，建议还是邮箱。得说清楚你用的哪个程序，报错爬的链接，报错长啥样(截图或者复制报错内容)，我debug起来比较方便。
...
文章在dir/article里，文件命名格式是 "标题by作者"；文本和文章在同一路径，文件命名格式是 "作者 发表日期（序号）"
