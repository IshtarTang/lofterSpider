...
有问题/报错提issue，不知道怎么提issue可以直接邮箱找我：ishtartang@163.com（但是不要在提了issue之后又给我发邮件），得说清楚你用的哪个程序，报错爬的链接，报错长啥样(截图或者复制报错内容)，我debug起来比较方便。

有的时候会懒得更新自述文件，所以配置项填写以代码里的注释为准。
